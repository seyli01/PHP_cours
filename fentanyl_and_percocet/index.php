...
<body>
    <div class="container">
        ...
        <div style="text-align: right; margin-bottom: 15px;">
            <a href="?logout=1" class="btn-delete" style="text-decoration: none; display: inline-block;">Se
                déconnecter</a>
        </div>
            ...
            <dialog id="editDialog">
                ...
                <form method="POST" action="" id="editForm">
                    ...
                    <input type="hidden" name="id" id="edit-id"
                        value="<?php echo $etudiant_a_modifier ? (int) $etudiant_a_modifier['id'] : ''; ?>">

                    <label for="edit-nom">Nom :</label>
                    <input type="text" id="edit-nom" name="nom" required
                        value="<?php echo $etudiant_a_modifier ? $etudiant_a_modifier['nom'] : ''; ?>">

                    <label for="edit-prenom">Prénom :</label>
                    <input type="text" id="edit-prenom" name="prenom" required
                        value="<?php echo $etudiant_a_modifier ? $etudiant_a_modifier['prenom'] : ''; ?>">

                    <label for="edit-age">Âge :</label>
                    <input type="number" id="edit-age" name="age" min="15" max="30" required
                        value="<?php echo $etudiant_a_modifier ? (int) $etudiant_a_modifier['age'] : ''; ?>">
        ...
        $ageMoyen = $stats['moyenne_age'];
        $repartition = $stats['par_classe'];
        ?>
